C
C
        SUBROUTINE RS1PLOT(X,N,NBOD,IW)
        IMPLICIT REAL *8 (A-H,O-Z)
        DIMENSION X(1),V(4)
C
C        THIS SUBROUTINE PLOTS THE CURVE SPECIFIED BY 
C        X 
C
C  INPUT PARAMETERS:
C   X - THE COORDINATE OF THE CURVE TO PLOT
C   N - THE NUMBER OF ELEMENTS IN ARRAYS X.
